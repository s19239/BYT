package refactoring.exercise06;
public class TicTacToe {
	...
	private TicTacToe(String s, int position, char player) {
		board = new StringBuffer(s);
	...
	public int winingMove(char player) {
		for (int i = 0; i < 9; i++) {
			if (board.charAt(i) == '-') {
	...
	//Making private
		private TicTacToe makeMove(int i, char player) {
