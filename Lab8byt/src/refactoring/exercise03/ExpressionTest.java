...
public class ExpressionTest {
	...
	public void testConstant() {
		...
		assertEquals(e.evaluate(), -43,0.1);
	}
	@Test
	public void testAddition() {
		Expression e = new Expression('+', new Expression(100), new Expression(
				-100));
		assertEquals(e.evaluate(), 0,0.1);
	}
	@Test
	public void testSubtraction() {
		Expression e = new Expression('-', new Expression(100), new Expression(
				-100));
		assertEquals(e.evaluate(), 200,0.1);
	}
	@Test
	public void testMultiplication() {
		Expression e = new Expression('*', new Expression(100), new Expression(
				-100));
		assertEquals(e.evaluate(), -10000,0.1);
	}
	@Test
	public void testDivision() {
		Expression e = new Expression('/', new Expression(100), new Expression(
				-100));
		assertEquals(e.evaluate(), -1,0.1);
	}
	@Test
	public void testComplexExpression() {
		...
		Expression e = new Expression('-', new Expression('+',
				...
				new Expression(5)));
		assertEquals(e.evaluate(), 0.6,0.1);
	}
